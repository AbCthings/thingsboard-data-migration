...
def saveToFile(key,timeseries,file):
    ...
    try:
        ...
        print("An error occoured while saving the data into text file: ", exception)
        sys.exit()
...
def readFromFile(key,file):
    ...
    try:
        ...
        print("An error occoured while reading the data from text file: ", exception)
        sys.exit()
...
if MODE == "send":
	...
	print("I read the following data: " + str(data))
